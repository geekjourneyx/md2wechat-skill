...
func TestRendererFalsePositiveBoundaries(t *testing.T) {
	tests := []struct {
		...
		{name: "annotate point needs index and title", markdown: ":::image-annotate\nimage: https://example.com/a.png\npoint: 01\n:::\n"},
		{name: "annotate point rejects empty recommended index", markdown: ":::image-annotate\nimage: https://example.com/a.png\npoint: | 主信息区 | 核心判断和主标题\n:::\n"},
		{name: "annotate point rejects empty recommended title", markdown: ":::image-annotate\nimage: https://example.com/a.png\npoint: 01 | | 核心判断和主标题\n:::\n"},
		{name: "annotate point accepts title without description", markdown: ":::image-annotate\nimage: https://example.com/a.png\npoint: 01 | 主信息区\n:::\n", accepted: true},
		{name: "annotate point accepts recommended format", markdown: ":::image-annotate\nimage: https://example.com/a.png\npoint: 01 | 主信息区 | 核心判断和主标题\n:::\n", accepted: true},
		{name: "annotate point rejects empty legacy index", markdown: ":::image-annotate\nimage: https://example.com/a.png\npoint: | 20 | 30 | 主信息区 | 核心判断和主标题\n:::\n"},
		{name: "annotate point rejects empty legacy title", markdown: ":::image-annotate\nimage: https://example.com/a.png\npoint: 01 | 20 | 30 | | 核心判断和主标题\n:::\n"},
		{name: "annotate point accepts legacy coordinates", markdown: ":::image-annotate\nimage: https://example.com/a.png\npoint: 01 | 20 | 30 | 主信息区 | 核心判断和主标题\n:::\n", accepted: true},
		{name: "annotate point accepts three points", markdown: ":::image-annotate\nimage: https://example.com/a.png\npoint: 01 | 一\npoint: 02 | 二\npoint: 03 | 三\n:::\n", accepted: true},
		{name: "annotate point rejects fourth point", markdown: ":::image-annotate\nimage: https://example.com/a.png\npoint: 01 | 一\npoint: 02 | 二\npoint: 03 | 三\npoint: 04 | 四\n:::\n"},
