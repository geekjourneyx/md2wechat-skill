...
```bash
go install github.com/geekjourneyx/md2wechat-skill/cmd/md2wechat@v2.10.1
md2wechat version --json
md2wechat skills read md2wechat --json
npx skills add https://github.com/geekjourneyx/md2wechat-skill --skill md2wechat
md2wechat capabilities --json
...
```bash
curl -fsSL https://github.com/geekjourneyx/md2wechat-skill/releases/download/v2.10.1/install.sh | bash
...
2. 如果我已经有稳定可用的 Go 环境，也可以改成：go install github.com/geekjourneyx/md2wechat-skill/cmd/md2wechat@v2.10.1
3. 如果以上两种都不适合，再运行：curl -fsSL https://github.com/geekjourneyx/md2wechat-skill/releases/download/v2.10.1/install.sh | bash
...
7. 运行：npx skills add https://github.com/geekjourneyx/md2wechat-skill --skill md2wechat
8. 运行：md2wechat capabilities --json
9. 如果 Obsidian / Claudian 里还是找不到 md2wechat，请提醒我去 Claudian 的 Settings -> Environment -> Custom variables，把 PATH 补上 ~/.local/bin
10. 最后告诉我如何在 Claudian 里输入 /md2wechat 或直接调用 md2wechat skill
