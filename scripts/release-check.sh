...
grep -q '53 个主推' docs/DISCOVERY.md || fail "DISCOVERY must define recommended syntax count"
grep -q '68 个主推' README.md || fail "README must define recommended scenario count"
